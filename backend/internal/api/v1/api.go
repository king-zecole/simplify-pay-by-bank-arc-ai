...
// AccountServer implements the ServerInterface generated by oapi-codegen
type AccountServer struct {
	accountService service.IAccountService
}

// NewAccountServer creates a new AccountServer instance
func NewAccountServer(accountService service.IAccountService) *AccountServer {
...
func (s *AccountServer) HealthCheck(w http.ResponseWriter, r *http.Request) {
